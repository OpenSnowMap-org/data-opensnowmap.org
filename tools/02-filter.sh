...
#______________________________________________________________________
# Filtering pistes
./osmfilter ${PLANET_DIR}planet.o5m --keep="piste:type= or aerialway= or railway=funicular or railway=incline or site=piste or landuse=winter_sports or sport=ski_jump or sport=skating or sport=ski_jump_take_off" > ${TMP_DIR}planet_pistes.osm
if [ $? -ne 0 ]
then
