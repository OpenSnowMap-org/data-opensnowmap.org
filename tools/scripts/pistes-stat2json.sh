downhillmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='downhill' and  osm_id > 0 and member_of is null;" | psql -d pistes-mapnik -U mapnik -t)
	
nordicmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='nordic' and  osm_id > 0 and member_of is null;" | psql -d pistes-mapnik -U mapnik -t)
    
aerialwaymeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
...
sledmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='sled' and  osm_id > 0 and member_of is null;" | psql -d pistes-mapnik -U mapnik -t)
	
hikemeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='hike' and  osm_id > 0 and member_of is null;" | psql -d pistes-mapnik -U mapnik -t)
	
skitourmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='skitour' and  osm_id > 0 and member_of is null;" | psql -d pistes-mapnik -U mapnik -t)
    
Rdownhillmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='downhill' and  osm_id < 0;" | psql -d pistes-mapnik -U mapnik -t)
	
Rnordicmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='nordic' and  osm_id < 0;" | psql -d pistes-mapnik -U mapnik -t)
    
Raerialwaymeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
...
Rsledmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='sled' and  osm_id < 0;" | psql -d pistes-mapnik -U mapnik -t)
	
Rhikemeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
	from planet_osm_line where \"piste:type\"='hike' and  osm_id < 0;" | psql -d pistes-mapnik -U mapnik -t)
	
Rskitourmeter=$(echo "select sum(ST_LengthSpheroid(st_transform(way,4326),'SPHEROID[\"WGS 84\",6378137,298.257223563]')) 
