...
#______________________________________________________________________
# Filtering pistes
./osmfilter ${PLANET_DIR}planet.o5m --keep="waterway= or bridge= or whitewater:section_grade= or whitewater:section_name= or whitewater:rapid_grade= or whitewater:rapid_name= or whitewater= or sport=canoe or kayak_rental= or route=canoe" > ${TMP_DIR}planet_ww-waterway.osm
if [ $? -ne 0 ]
then
